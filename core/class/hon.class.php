...
class hon extends eqLogic {
    ...
    private function createSelectionWorkflowCommands() {
        ...
        if (in_array($applianceCode, ['WM', 'WD'])) {
            ...
            $this->createSelectActionCommand('set_temp', 'Régler la température', []); // liste vide tant qu’aucun programme
        }
    }
    ...
    public function execute($_options = array()) {
        ...
        if ($logicalId == 'refresh') {
            ...
            try {
                ...
                // Adapter set_temp dynamiquement (la fonction elle-même filtre WM/WD)
